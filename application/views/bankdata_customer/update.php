                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="Bank" id="Bank" placeholder="Bank" value="<?= $data["Bank"]; ?>">
                                <?= form_error("Bank", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="TypeCard">TypeCard</label>
                                <input class="form-control" type="text" name="TypeCard" id="TypeCard" placeholder="TypeCard" value="<?= $data["TypeCard"]; ?>">
                                <?= form_error("TypeCard", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="NameCustomer">NameCustomer</label>
                                <input class="form-control" type="text" name="NameCustomer" id="NameCustomer" placeholder="NameCustomer" value="<?= $data["NameCustomer"]; ?>">
                                <?= form_error("NameCustomer", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="PIC">PIC</label>
                                <input class="form-control" type="text" name="PIC" id="PIC" placeholder="PIC" value="<?= $data["PIC"]; ?>">
                                <?= form_error("PIC", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="AssignmentDate">AssignmentDate</label>
                                <input class="form-control" type="text" name="AssignmentDate" id="AssignmentDate" placeholder="AssignmentDate" value="<?= $data["AssignmentDate"]; ?>">
                                <?= form_error("AssignmentDate", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="ExpireDate">ExpireDate</label>
                                <input class="form-control" type="text" name="ExpireDate" id="ExpireDate" placeholder="ExpireDate" value="<?= $data["ExpireDate"]; ?>">
                                <?= form_error("ExpireDate", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="DateOfBirth">DateOfBirth</label>
                                <input class="form-control" type="text" name="DateOfBirth" id="DateOfBirth" placeholder="DateOfBirth" value="<?= $data["DateOfBirth"]; ?>">
                                <?= form_error("DateOfBirth", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="OpenDate">OpenDate</label>
                                <input class="form-control" type="text" name="OpenDate" id="OpenDate" placeholder="OpenDate" value="<?= $data["OpenDate"]; ?>">
                                <?= form_error("OpenDate", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="WODate">WODate</label>
                                <input class="form-control" type="text" name="WODate" id="WODate" placeholder="WODate" value="<?= $data["WODate"]; ?>">
                                <?= form_error("WODate", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="LastPayDate">LastPayDate</label>
                                <input class="form-control" type="text" name="LastPayDate" id="LastPayDate" placeholder="LastPayDate" value="<?= $data["LastPayDate"]; ?>">
                                <?= form_error("LastPayDate", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="LastTransactionDate">LastTransactionDate</label>
                                <input class="form-control" type="text" name="LastTransactionDate" id="LastTransactionDate" placeholder="LastTransactionDate" value="<?= $data["LastTransactionDate"]; ?>">
                                <?= form_error("LastTransactionDate", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="LastPayment">LastPayment</label>
                                <input class="form-control" type="text" name="LastPayment" id="LastPayment" placeholder="LastPayment" value="<?= $data["LastPayment"]; ?>">
                                <?= form_error("LastPayment", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="LastTransactionNominal">LastTransactionNominal</label>
                                <input class="form-control" type="text" name="LastTransactionNominal" id="LastTransactionNominal" placeholder="LastTransactionNominal" value="<?= $data["LastTransactionNominal"]; ?>">
                                <?= form_error("LastTransactionNominal", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="Limit">Limit</label>
                                <input class="form-control" type="text" name="Limit" id="Limit" placeholder="Limit" value="<?= $data["Limit"]; ?>">
                                <?= form_error("Limit", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="Principal">Principal</label>
                                <input class="form-control" type="text" name="Principal" id="Principal" placeholder="Principal" value="<?= $data["Principal"]; ?>">
                                <?= form_error("Principal", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="MinPay">MinPay</label>
                                <input class="form-control" type="text" name="MinPay" id="MinPay" placeholder="MinPay" value="<?= $data["MinPay"]; ?>">
                                <?= form_error("MinPay", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="OSBalance">OSBalance</label>
                                <input class="form-control" type="text" name="OSBalance" id="OSBalance" placeholder="OSBalance" value="<?= $data["OSBalance"]; ?>">
                                <?= form_error("OSBalance", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="Address1">Address1</label>
                                <input class="form-control" type="text" name="Address1" id="Address1" placeholder="Address1" value="<?= $data["Address1"]; ?>">
                                <?= form_error("Address1", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="Address2">Address2</label>
                                <input class="form-control" type="text" name="Address2" id="Address2" placeholder="Address2" value="<?= $data["Address2"]; ?>">
                                <?= form_error("Address2", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="Address3">Address3</label>
                                <input class="form-control" type="text" name="Address3" id="Address3" placeholder="Address3" value="<?= $data["Address3"]; ?>">
                                <?= form_error("Address3", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="Address4">Address4</label>
                                <input class="form-control" type="text" name="Address4" id="Address4" placeholder="Address4" value="<?= $data["Address4"]; ?>">
                                <?= form_error("Address4", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="City">City</label>
                                <input class="form-control" type="text" name="City" id="City" placeholder="City" value="<?= $data["City"]; ?>">
                                <?= form_error("City", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="OfficeName">OfficeName</label>
                                <input class="form-control" type="text" name="OfficeName" id="OfficeName" placeholder="OfficeName" value="<?= $data["OfficeName"]; ?>">
                                <?= form_error("OfficeName", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="OfficeAddress1">OfficeAddress1</label>
                                <input class="form-control" type="text" name="OfficeAddress1" id="OfficeAddress1" placeholder="OfficeAddress1" value="<?= $data["OfficeAddress1"]; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="OfficeAddress4" id="OfficeAddress4" placeholder="OfficeAddress4" value="<?= $data["OfficeAddress4"]; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="ECName" id="ECName" placeholder="ECName" value="<?= $data["ECName"]; ?>">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="StatusEC2" id="StatusEC2" placeholder="StatusEC2" value="<?= $data["StatusEC2"]; ?>">
                                <?= form_error("StatusEC2", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="MotherName">MotherName</label>
                                <input class="form-control" type="text" name="MotherName" id="MotherName" placeholder="MotherName" value="<?= $data["MotherName"]; ?>">
                                <?= form_error("MotherName", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="Sex">Sex</label>
                                <input class="form-control" type="text" name="Sex" id="Sex" placeholder="Sex" value="<?= $data["Sex"]; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="VirtualAccount" id="VirtualAccount" placeholder="VirtualAccount" value="<?= $data["VirtualAccount"]; ?>">
                                <?= form_error("VirtualAccount", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="VirtualAccountName">VirtualAccountName</label>
                                <input class="form-control" type="text" name="VirtualAccountName" id="VirtualAccountName" placeholder="VirtualAccountName" value="<?= $data["VirtualAccountName"]; ?>">
                                <?= form_error("VirtualAccountName", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="Komoditi">Komoditi</label>
                                <input class="form-control" type="text" name="Komoditi" id="Komoditi" placeholder="Komoditi" value="<?= $data["Komoditi"]; ?>">
                                <?= form_error("Komoditi", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="KomoditiType">KomoditiType</label>
                                <input class="form-control" type="text" name="KomoditiType" id="KomoditiType" placeholder="KomoditiType" value="<?= $data["KomoditiType"]; ?>">
                                <?= form_error("KomoditiType", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="Produsen">Produsen</label>
                                <input class="form-control" type="text" name="Produsen" id="Produsen" placeholder="Produsen" value="<?= $data["Produsen"]; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="DPD" id="DPD" placeholder="DPD" value="<?= $data["DPD"]; ?>">
                                <?= form_error("DPD", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="Bucket">Bucket</label>
                                <input class="form-control" type="text" name="Bucket" id="Bucket" placeholder="Bucket" value="<?= $data["Bucket"]; ?>">
                                <?= form_error("Bucket", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="BillingNoPenalty">BillingNoPenalty</label>
                                <input class="form-control" type="text" name="BillingNoPenalty" id="BillingNoPenalty" placeholder="BillingNoPenalty" value="<?= $data["BillingNoPenalty"]; ?>">
                                <?= form_error("BillingNoPenalty", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="DendaBelumDibayar">DendaBelumDibayar</label>
                                <input class="form-control" type="text" name="DendaBelumDibayar" id="DendaBelumDibayar" placeholder="DendaBelumDibayar" value="<?= $data["DendaBelumDibayar"]; ?>">
                                <?= form_error("DendaBelumDibayar", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="LastVisitDate">LastVisitDate</label>
                                <input class="form-control" type="text" name="LastVisitDate" id="LastVisitDate" placeholder="LastVisitDate" value="<?= $data["LastVisitDate"]; ?>">
                                <?= form_error("LastVisitDate", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="LastVisitResult">LastVisitResult</label>
                                <input class="form-control" type="text" name="LastVisitResult" id="LastVisitResult" placeholder="LastVisitResult" value="<?= $data["LastVisitResult"]; ?>">
                                <?= form_error("LastVisitResult", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="LastReport">LastReport</label>
                                <input class="form-control" type="text" name="LastReport" id="LastReport" placeholder="LastReport" value="<?= $data["LastReport"]; ?>">
                                <?= form_error("LastReport", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="LastVisitAddress">LastVisitAddress</label>
                                <input class="form-control" type="text" name="LastVisitAddress" id="LastVisitAddress" placeholder="LastVisitAddress" value="<?= $data["LastVisitAddress"]; ?>">
                                <?= form_error("LastVisitAddress", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="OTSOffer">OTSOffer</label>
                                <input class="form-control" type="text" name="OTSOffer" id="OTSOffer" placeholder="OTSOffer" value="<?= $data["OTSOffer"]; ?>">
                                <?= form_error("OTSOffer", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="OtherData1">OtherData1</label>
                                <input class="form-control" type="text" name="OtherData1" id="OtherData1" placeholder="OtherData1" value="<?= $data["OtherData1"]; ?>">
                                <?= form_error("OtherData1", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="OtherData2">OtherData2</label>
                                <input class="form-control" type="text" name="OtherData2" id="OtherData2" placeholder="OtherData2" value="<?= $data["OtherData2"]; ?>">
                                <?= form_error("OtherData2", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="OtherData3">OtherData3</label>
                                <input class="form-control" type="text" name="OtherData3" id="OtherData3" placeholder="OtherData3" value="<?= $data["OtherData3"]; ?>">
                                <?= form_error("OtherData3", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="OtherData4">OtherData4</label>
                                <input class="form-control" type="text" name="OtherData4" id="OtherData4" placeholder="OtherData4" value="<?= $data["OtherData4"]; ?>">
                                <?= form_error("OtherData4", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="OtherData5">OtherData5</label>
                                <input class="form-control" type="text" name="OtherData5" id="OtherData5" placeholder="OtherData5" value="<?= $data["OtherData5"]; ?>">
                                <?= form_error("OtherData5", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="PermanentMessage">PermanentMessage</label>
                                <input class="form-control" type="text" name="PermanentMessage" id="PermanentMessage" placeholder="PermanentMessage" value="<?= $data["PermanentMessage"]; ?>">
                                <?= form_error("PermanentMessage", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="Deskcoll_id">Deskcoll_id</label>
                                <input class="form-control" type="text" name="Deskcoll_id" id="Deskcoll_id" placeholder="Deskcoll_id" value="<?= $data["Deskcoll_id"]; ?>">
                                <?= form_error("Deskcoll_id", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="IsDeletedByAdmin">IsDeletedByAdmin</label>
                                <input class="form-control" type="text" name="IsDeletedByAdmin" id="IsDeletedByAdmin" placeholder="IsDeletedByAdmin" value="<?= $data["IsDeletedByAdmin"]; ?>">
                                <?= form_error("IsDeletedByAdmin", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="Report">Report</label>
                                <input class="form-control" type="text" name="Report" id="Report" placeholder="Report" value="<?= $data["Report"]; ?>">
                                <?= form_error("Report", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="Action">Action</label>
                                <input class="form-control" type="text" name="Action" id="Action" placeholder="Action" value="<?= $data["Action"]; ?>">
                                <?= form_error("Action", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="ReportDate">ReportDate</label>
                                <input class="form-control" type="text" name="ReportDate" id="ReportDate" placeholder="ReportDate" value="<?= $data["ReportDate"]; ?>">
                                <?= form_error("ReportDate", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="PTPDate">PTPDate</label>
                                <input class="form-control" type="text" name="PTPDate" id="PTPDate" placeholder="PTPDate" value="<?= $data["PTPDate"]; ?>">
                                <?= form_error("PTPDate", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="PTPAmount">PTPAmount</label>
                                <input class="form-control" type="text" name="PTPAmount" id="PTPAmount" placeholder="PTPAmount" value="<?= $data["PTPAmount"]; ?>">
                                <?= form_error("PTPAmount", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="PaidDate">PaidDate</label>
                                <input class="form-control" type="text" name="PaidDate" id="PaidDate" placeholder="PaidDate" value="<?= $data["PaidDate"]; ?>">
                                <?= form_error("PaidDate", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="PaidAmount">PaidAmount</label>
                                <input class="form-control" type="text" name="PaidAmount" id="PaidAmount" placeholder="PaidAmount" value="<?= $data["PaidAmount"]; ?>">
