            ...
            <div class="card-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="title_halaman" id="title_halaman" placeholder="Title halaman" value="<?= set_value("title_halaman"); ?>">
                        <?= form_error("title_halaman", '<small class="text-danger">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="short_halaman">short halaman</label>
                        <input class="form-control" type="text" name="short_halaman" id="short_halaman" placeholder="short halaman" value="<?= set_value("short_halaman"); ?>">
                        <?= form_error("short_halaman", '<small class="text-danger">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="content_halaman">content halaman</label>
                        <textarea name="content_halaman" id="content_halaman" class="summernote"><?= set_value("content_halaman"); ?></textarea>
                        <?= form_error("content_halaman", '<small class="text-danger">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="meta_keyword_halaman">Meta keyword halaman</label>
                        <input class="form-control" type="text" name="meta_keyword_halaman" id="meta_keyword_halaman" placeholder="Meta Keyword halaman" value="<?= set_value("meta_keyword_halaman"); ?>">
                        <?= form_error("meta_keyword_halaman", '<small class="text-danger">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="meta_desc_halaman">Meta desc halaman</label>
                        <input class="form-control" type="text" name="meta_desc_halaman" id="meta_desc_halaman" placeholder="Meta desc halaman" value="<?= set_value("meta_desc_halaman"); ?>">
                        <?= form_error("meta_desc_halaman", '<small class="text-danger">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="image_halaman">Image halaman</label>
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="aktif_halaman" id="aktif_halaman" value="1" <?= (set_value('aktif_halaman') == '1') ? 'checked' : '' ?>>
