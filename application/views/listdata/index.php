...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-dark h4">Data Yang Tersedia
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <p class="font-weight-bold col-10"><?= ($data['judul_data']); ?></p>
                                        <a href="/portal/<?= ($data['url']); ?>" class="btn btn-primary col-md-auto ">Lihat Data</a>
                                    </div>
                                </div>
                            </div>
                        </div>
