                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="namamenu" id="namamenu" placeholder="Masukan Nama Menu" value="<?= set_value("namamenu"); ?>">
                                <?= form_error("namamenu", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="url_menu">URL Menu</label>
                                <input class="form-control" type="text" name="url_menu" id="url_menu" placeholder="Masukan URL Menu" value="<?= set_value("url_menu"); ?>">
                                <?= form_error("url_menu", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="icon_menu">Icon Menu</label>
                                <input class="form-control" type="text" name="icon_menu" id="icon_menu" placeholder="Masukan Icon Menu" value="<?= set_value("icon_menu"); ?>">
                                <?= form_error("icon_menu", '<small class="text-danger">', '</small>'); ?>
                            </div>                            
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="is_head" name="is_head" <?= (set_value("is_head") == "1") ? "checked" : ""; ?>>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select class="custom-select" id="level_menu" name="level_menu">
                                        <option value="1" <?= (set_value("level_menu") == "1") ? "selected" : ""; ?>>Menu Pertama</option>
                                        <option value="2" <?= (set_value("level_menu") == "2") ? "selected" : ""; ?>>Menu Kedua</option>
                                    </select>
                                </div>
                                ...
                                <div class="input-group">
                                    <select class="custom-select" id="menu_head" name="menu_head">
                                        ...
                                        <?php foreach ($menu_head as $key) : ?>
                                            <?php if (set_value("menu_head") == $key['IDMenu']) : ?>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="sort" id="sort" placeholder="Masukan Sort" value="<?= set_value("sort"); ?>">
                                <?= form_error("sort", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" <?= (set_value("is_active") == "1") ? "checked" : ""; ?>>
