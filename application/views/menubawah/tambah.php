            ...
            <div class="card-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="name_menubawah" id="name_menubawah" placeholder="Nama Menu" value="<?= set_value("name_menubawah"); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" name="posisi" id="posisi" placeholder="posisi" value="<?= set_value("posisi"); ?>">
