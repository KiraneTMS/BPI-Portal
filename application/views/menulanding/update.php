    ...
    <div class="col-md-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-dark h4">Ubah Menu</h6>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="name_menulanding" id="name_menulanding" placeholder="Masukan Nama menu" value="<?= $data["name_menulanding"]; ?>">
                                ...
                                <div class="input-group">
                                    <select class="custom-select" id="parent_menulanding" name="parent_menulanding">
                                        ...
                                        <?php foreach ($menu as $key) : ?>
                                            <?php if ($data["parent_menulanding"] == $key['id_menulanding']) : ?>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="jenis_menulanding" id="jenis_menulanding">
                                    <option value="1" <?= ($data['jenis_menulanding'] == "1") ? "selected" : "" ?>>External</option>
                                    <option value="2" <?= ($data['jenis_menulanding'] == "2") ? "selected" : "" ?>>Internal</option>
                                </select>
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="status_menulanding" name="status_menulanding" <?= ($data["status_menulanding"] == "1") ? "checked" : ""; ?>>
                                ...
                                <div class="col-auto">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="head_menulanding" name="head_menulanding" <?= ($data["head_menulanding"] == "1") ? "checked" : ""; ?>>
                        ...
                        <div class="col-md-6">
                            <div class="form-group" id="box_href_menulanding">
                                ...
                                <input class="form-control" type="text" name="href_menulanding" id="href_menulanding" placeholder="Masukan Link menu" value="<?= $data["href_menulanding"]; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select class="custom-select" id="level_menulanding" name="level_menulanding">
                                        <option value="1" <?= ($data['level_menulanding'] == "1") ? "selected" : "" ?>>Menu Pertama</option>
                                        <option value="2" <?= ($data['level_menulanding'] == "2") ? "selected" : "" ?>>Menu Kedua</option>
                                        <option value="3" <?= ($data['level_menulanding'] == "3") ? "selected" : "" ?>>Menu Ketiga</option>
                                    </select>
                                </div>
                                <?= form_error("id_halaman", '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="sort_menulanding" id="sort_menulanding" placeholder="Masukan sort menu" value="<?= $data["sort_menulanding"]; ?>">
