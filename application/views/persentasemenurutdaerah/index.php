...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-dark h4">Persentase Menurut Daerah
            <a href="<?= base_url("persentasemenurutdaerah/downloadsql"); ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm float-right ml-1">
                    ...
                    <script>
                        $(document).ready(function() {
                            table = $('#datatable').DataTable({
                                ...
                                "ajax": {
                                    "url": "<?= base_url("persentasemenurutdaerah/datatable"); ?>",
                                    "type": "POST",
                                    // "data": function(data){
