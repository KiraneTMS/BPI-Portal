            ...
            <div class="card-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="nama_testimonial" id="nama_testimonial" placeholder="nama testimonial" value="<?= $data["nama_testimonial"]; ?>">
                        <?= form_error("nama_testimonial", '<small class="text-danger">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="job_testimonial">job testimonial</label>
                        <input class="form-control" type="text" name="job_testimonial" id="job_testimonial" placeholder="job testimonial" value="<?= $data["job_testimonial"]; ?>">
                        <?= form_error("job_testimonial", '<small class="text-danger">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="text_testimonial">text testimonial</label>
                        <input class="form-control" type="text" name="text_testimonial" id="text_testimonial" placeholder="text testimonial" value="<?= $data["text_testimonial"]; ?>">
                        <?= form_error("text_testimonial", '<small class="text-danger">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="image_testimonial">Image testimonial</label><br>
                        <img src="<?= base_url('uploads/') . $data['image_testimonial']; ?>" alt="" style="width: 50%;" class="mb-3">
