    ...
    <div class="col-md-6">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-dark h4">Update Data Unit</h6>
            </div>
            <div class="card-body">
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="KodeUnit" id="KodeUnit" placeholder="Masukan Huruf Unit" value="<?= $data["KodeUnit"]; ?>">
                        <?= form_error("KodeUnit", '<small class="text-danger">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="LuasUnitKotor">Masukan Total Luas Unit Kotor</label>
                        <input class="form-control" type="number" name="LuasUnitKotor" id="LuasUnitKotor" placeholder="Masukan Luas Unit Kotor" value="<?= $data["LuasUnitKotor"]; ?>">
                        <?= form_error("LuasUnitKotor", '<small class="text-danger">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="LuasUnit">Masukan Luas Unit</label>
                        <input class="form-control" type="number" name="LuasUnit" id="LuasUnit" placeholder="Masukan Luas Unit" value="<?= $data["LuasUnit"]; ?>">
                        <?= form_error("LuasUnit", '<small class="text-danger">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="SisaLuasUnitKotor">Sisa Luas Unit Kotor</label>
                        <input class="form-control" type="number" name="SisaLuasUnitKotor" id="SisaLuasUnitKotor" placeholder="Masukan Luas Unit" value="<?= $data["SisaLuasUnitKotor"]; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="KordinatMaps" id="KordinatMaps" placeholder="Masukan Kordinat Maps" value="<?= $data["KordinatMaps"]; ?>">
                        <?= form_error("KordinatMaps", '<small class="text-danger">', '</small>'); ?>
                    </div>
                    <!-- <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="IsAktifUnitMaps" name="IsAktifUnitMaps" <?= ($data['IsAktifUnitMaps'] == "1") ? "checked" : "" ?>>
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="IsAktifUnit" name="IsAktifUnit" <?= ($data['IsAktifUnit'] == "1") ? "checked" : "" ?>>
